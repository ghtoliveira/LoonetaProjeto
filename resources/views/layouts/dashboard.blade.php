 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('painel') }}">Looneta - Painel Administrativo - {{ Auth::user()->name }}</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (Request::is('/painel') ? 'class="active"' : '') }}>
                            <a href="{{ url ('/painel') }}"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li {{ (Request::is('*usuario') ? 'class="active"' : '') }}>
                            <a href="{{ route ('buscarUsuarioView') }}"><i class="fa fa-users fa-fw"></i> Buscar Usuarios</a>
                            <!-- /.nav-second-level -->
                        </li>
                        <li {{ (Request::is('*/tags') ? 'class="active"' : '') }}>
                            <a href="{{ url ('/painel/tags') }}"><i class="fa fa-tags fa-fw"></i> Tags</a>
                        </li>
                        <li {{ (Request::is('*status') ? 'class="active"' : '') }}>
